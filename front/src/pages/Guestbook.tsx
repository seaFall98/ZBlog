...
export default function Guestbook() {
  ...
  return (
    <PageLayout headerVariant="guestbook" noMainTopPadding>
      <section className="guestbook-hero" style={{ backgroundImage: `linear-gradient(rgba(8, 8, 8, 0.22), rgba(8, 8, 8, 0.44)), url(${backgroundImage})` }}>
        ...
        <div className="guestbook-hero__content">
          ...
          <h1>留下你的话</h1>
          <p>{profile.messageContent || "把想说的话留在这里，让它慢慢飘过留言墙。"}</p>
