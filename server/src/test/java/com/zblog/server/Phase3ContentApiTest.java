...
class Phase3ContentApiTest {
  ...
  void publicApisExposeSeededBlogContentForFrontend() {
    ...
    ResponseEntity<Map> articleResponse =
        restTemplate.getForEntity("/api/v1/articles/hello-zblog", Map.class);
