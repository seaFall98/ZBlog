<template>
  <div class="sidebar" :class="{ 'is-collapse': isCollapse }">
    <div class="logo">
      <span v-show="!isCollapse">ZBlog 管理系统</span>
    </div>
    <el-menu
      ref="menuRef"
    ...
    >
      ...
      <el-sub-menu index="ops">
        ...
        <el-menu-item index="/ops/mail-outbox">
...
// 子菜单索引列表
const subMenus = ['content', 'interaction', 'ops', 'management'];
