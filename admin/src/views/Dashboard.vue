    ...
    <el-card class="quick-access-card" shadow="hover">
      ...
      <div class="quick-access-content">
        <div class="quick-links">
          <div class="link-item" @click="openLink('https://github.com/seaFall98')">
            <span class="link-text">GitHub</span>
            <el-icon class="link-icon">
              <Right />
            </el-icon>
          </div>
          <div class="link-item" @click="openLink('/settings')">
            <span class="link-text">设置</span>
            <el-icon class="link-icon">
              <Right />
            </el-icon>
          </div>
          <div class="link-item" @click="openLink('/articles')">
            <span class="link-text">文章</span>
            <el-icon class="link-icon">
              <Right />
            </el-icon>
          </div>
          <div class="link-item" @click="openLink('http://localhost:3000')">
