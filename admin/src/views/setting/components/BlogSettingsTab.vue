<template>
  <el-form :model="form" label-width="120px" class="setting-form">
    ...
    <div class="image-row">
      ...
      <el-form-item label="弹幕墙背景">
        <ImageUploader
          ref="barrageBackgroundUploaderRef"
          v-model="form.barrage_background_image"
          upload-type="弹幕墙背景"
          width="213px"
          height="120px"
          :disabled="loading"
...
interface BlogFormData {
  ...
  barrage_background_image: string;
  screenshot: string;
  announcement: string;
...
const barrageBackgroundUploaderRef = ref<InstanceType<typeof ImageUploader>>();
