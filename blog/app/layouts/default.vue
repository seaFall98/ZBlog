...
const wideContent = computed(() => Boolean(route.meta.wideContent) || route.path.startsWith('/album'));
...
<template>
  <div class="layout-wrapper">
    <Navbar />
    <Header />
    <main class="page-main" :class="{ 'message-page-main': isMessagePage }">
      <MomentWidget v-if="showMomentWidget" />
      <div class="main-layout" :class="wideContent ? 'wide-content' : ''">
