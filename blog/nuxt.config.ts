export default defineNuxtConfig({
  ...
  robots: {
    allow: '/',
    disallow: ['/admin/', '/profile', '/notifications', '/oauth/', '/feedback/query'],
  ...
  routeRules: {
    '/oauth/**': { sitemap: false, robots: false },
    '/profile': { sitemap: false, robots: false },
    '/notifications': { sitemap: false, robots: false },
    '/feedback': { sitemap: false },
    '/feedback/query': { sitemap: false, robots: false },
