...
3. `0_PROJECT_CONTEXT.md` - stable product and architecture context.
4. `RETRO_ACCEPTANCE_LOOP.md` - why phase labels are not completion evidence.
5. `ATTRIBUTION.md` - upstream/reference attribution notes.
